...
<div class="col-lg-8">
    ...
    {{--  enctype="multipart/form-data" di gunakan untuk mengambil semua jenis data --}}
    <form action="/dashboard/posts" method="post" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3 ">
          ...
          @enderror --}}
          {{-- <input type="textarea" id="body" name="body" value="{{  old('body') }}"> --}}
          <textarea type="hidden" id="body" name="body">{{old('body')}}</textarea>
        </div>
        {{-- end --}}
