...
<div class="container">
    <div class="row my-3">
     <div class="col-lg-8">
         ...
         <a href="/dashboard/posts" class="btn btn-success"> <span data-feather="corner-up-left"></span>  Back to all my posts</a>
         ...
         <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="d-inline">
          ...
          @else  
          <img src="https://source.unsplash.com/1200x400?{{ $post->category->name }}" class="img-fluid mt-4" alt="{{ $post->category->name }}">
          @endif
